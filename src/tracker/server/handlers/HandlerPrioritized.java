...
public class HandlerPrioritized implements HttpHandler {
    ...
    public void handle(HttpExchange exchange) throws IOException {
        ...
        if (method.equals("GET")) {
            ...
            var prioritized = HttpTaskServer.inMemoryTaskManager.getPrioritizedTasks();
            var result = gson.toJson(prioritized);
